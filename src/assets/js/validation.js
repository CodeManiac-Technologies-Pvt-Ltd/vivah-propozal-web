...
$(document).ready(function(){
    ...
    jQuery.validator.addMethod("notEqualTo", function(value, element)
       ...
       jQuery.validator.addMethod("checkUsernameAtAdmin", function(value, element, params)
       {
       ...
       jQuery.validator.addMethod("checkEmailExistAtAdmin", function(value, element, params)
       {
           var response = true;
       ...
       jQuery.validator.addMethod("checkAadhaarExist", function(value, element)
       {
           var response = false;

           var post_url_check_aadhaar = baseurl + "user/checkAadhaarExist/";
           var strng = value + ''
           ...
           if(strng.length == 12)
           {
               $.ajax({
                      type: "POST",
                      url: post_url_check_aadhaar,
                      data: {aadhaar_no : value},
                      dataType: "json",
                      async: false
               }).done(function(result){
                    if(result.status == true){
       ...
       }, "Aadhaar number already Present.");
